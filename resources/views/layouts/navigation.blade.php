                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            @php
                                $unreadCount = Modules\Task\Models\Task::unreadCount(Auth::id());
                            @endphp

                            @if ($unreadCount > 0)
                                <span
                                    class="inline-block w-4 h-4 bg-red-600 text-white text-xs font-bold leading-tight text-center rounded-full me-2 ms-2 absolute"
                                    style="left: -10px; top: 50%; transform: translateY(-50%);">{{ $unreadCount }}</span>
                            @endif
